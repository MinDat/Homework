...
class Book(models.Model):
    ...
    published_countries = models.ManyToManyField(Country, related_name="doge")

    def get_absolute_url(self):
        return reverse("row-id", args=[self.slug])
    ...
    def __str__(self):
        return f" { self.title} | {self.rating} | {self.author} | {self.isTrending} | {self.slug} | {self.published_countries} "